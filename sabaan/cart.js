...
var save = 0;
  ...
  var tokencheck =true;
//   document.getElementById("discnt").addEventListener("click",discountedprice );
...
function reducePrice(totally_total){
    ...
    if(cc.value == "abcd" ){
        if(totally_total >= 2000)
         save =  totally_total - 500;
    //    var totally_total = (60/100) * (totally_total);
        

        var whole_total  = document.getElementById("Ordertotal");

        whole_total.textContent = (Number)(37) + save.toFixed(2) ;
